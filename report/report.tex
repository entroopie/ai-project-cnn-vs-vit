...
The CNN (Figure~\ref{fig:curves}, top) shows intermittent validation-loss spikes at
epochs 6--8 and 14 (gap up to $+0.051$), stabilised by \texttt{ReduceLROnPlateau} and
stopped early at epoch~16. The ViT (Figure~\ref{fig:curves}, bottom) exhibits no such
